...
### [责任链 - `ChainOfResponsibility`](Behavioral/ChainOfResponsibility)
...
### [中介者 - `Mediator`](Behavioral/Mediator)
...
### [备忘录 - `Memento`](Behavioral/Memento)
...
### [空对象 - `NullObject`](Behavioral/NullObject)
...
### [规格(或约) - `Specification`](Behavioral/Specification)
...
### [模板方法 - `TemplateMethod`](Behavioral/TemplateMethod)
...
### [抽象工厂 - `AbstractFactory`](Creational/AbstractFactory)
...
### [创建(建造)者或生成器 - `Builder`](Creational/Builder)
...
### [工厂方法 - `FactoryMethod`](Creational/FactoryMethod)
...
### [多例 - `Multiton`](Creational/Multiton)
...
### [简单工厂 - `SimpleFactory`](Creational/SimpleFactory)
...
### [静态工厂 - `StaticFactory`](Creational/StaticFactory)
...
### [组合 - `Composite`](Structural/Composite)
...
### [数据映射器 - `DataMapper`](Structural/DataMapper)
...
### [装饰器 - `Decorator`](Structural/Decorator)
...
### [依赖注入 - `DependencyInjection`](Structural/DependencyInjection)
...
### [连贯接口 - `FluentInterface`](Structural/FluentInterface)
...
### [享元 - `Flyweight`](Structural/Flyweight)
...
### [注册 - `Registry`](Structural/Registry)
